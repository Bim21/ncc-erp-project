    ...
    public class ConfigurationAppService : ProjectManagementAppServiceBase, IConfigurationAppService
    {
        ...
        public async Task<AppSettingDto> Get()
        {
            return new AppSettingDto
            {
                ...
                UpdateProject = await SettingManager.GetSettingValueForApplicationAsync(AppSettingNames.UpdateProject),
        ...
        public async Task<AppSettingDto> Change(AppSettingDto input)
        {
            if (string.IsNullOrEmpty(input.ClientAppId) ||
                ...
                string.IsNullOrEmpty(input.UpdateProject) ||
            ...
            await SettingManager.ChangeSettingForApplicationAsync(AppSettingNames.UpdateProject, input.UpdateProject);
