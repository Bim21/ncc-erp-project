...
namespace ProjectManagement.Utils
{
    public class CommonUtil
    {
        ...
        = new Dictionary<byte, string>
        {
            ...
            { 29, "29th next month" },
            { 30, "30th next month" },
            { 31, "1st next two month" },
            { 32, "2nd next two month" },
            { 33, "3rd next two month" },
            { 34, "4th next two month" },
            { 35, "5th next two month" },
            { 36, "6th next two month" },
            { 37, "7th next two month" },
            { 38, "8th next two month" },
            { 39, "9th next two month" },
            { 40, "10th next two month" },
            { 41, "11th next two month" },
            { 42, "12th next two month" },
            { 43, "13th next two month" },
            { 44, "14th next two month" },
            { 45, "15th next two month" },
            { 46, "16th next two month" },
            { 47, "17th next two month" },
            { 48, "18th next two month" },
            { 49, "19th next two month" },
            { 50, "20th next two month" },
            { 51, "21st next two month" },
            { 52, "22nd next two month" },
            { 53, "23rd next two month" },
            { 54, "24th next two month" },
            { 55, "25th next two month" },
            { 56, "26th next two month" },
            { 57, "27th next two month" },
            { 58, "28th next two month" },
            { 59, "29th next two month" },
            { 60, "30th next two month" },
            { 61, "1st next three month" },
            { 62, "2nd next three month" },
            { 63, "3rd next three month" },
            { 64, "4th next three month" },
            { 65, "5th next three month" },
            { 66, "6th next three month" },
            { 67, "7th next three month" },
            { 68, "8th next three month" },
            { 69, "9th next three month" },
            { 70, "10th next three month" },
            { 71, "11th next three month" },
            { 72, "12th next three month" },
            { 73, "13th next three month" },
            { 74, "14th next three month" },
            { 75, "15th next three month" },
            { 76, "16th next three month" },
            { 77, "17th next three month" },
            { 78, "18th next three month" },
            { 79, "19th next three month" },
            { 80, "20th next three month" },
            { 81, "21st next three month" },
            { 82, "22nd next three month" },
            { 83, "23rd next three month" },
            { 84, "24th next three month" },
            { 85, "25th next three month" },
            { 86, "26th next three month" },
            { 87, "27th next three month" },
            { 88, "28th next three month" },
            { 89, "29th next three month" },
            { 90, "30th next three month" },
        };
