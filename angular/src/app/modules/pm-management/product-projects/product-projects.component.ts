...
export class ProductProjectsComponent extends PagedListingComponentBase<any> implements OnInit {
  ...
  public isEnablePMFilter(){
    return this.permission.isGranted( this.Projects_ProductProjects_ViewMyProjectOnly) && !this.permission.isGranted(this.Projects_ProductProjects_ViewAllProject)
  }
